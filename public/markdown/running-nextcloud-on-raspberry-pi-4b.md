...
![NextCloud Create Account](/post_images/nextcloud-create-account.png)
...
![Cloudflare Zero Trust](/post_images/zero-trust-cloudflare.png)

Then press the tunnel tab and create a new tunnel.

![Create Tunnel](/post_images/create-tunnel.png)
...
![Add Connector](/post_images/add-connector.png)
...
![Add Public Hostname](/post_images/add-public-hostname.png)
...
![Tunnel Routing Cloudflare](/post_images/tunnel-routing-cloudflare.png)
