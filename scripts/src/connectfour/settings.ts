...
function SaveColors() {
	const playerColor = (
		document.getElementById("playerColorSelect") as HTMLSelectElement
	).value;

	const opponentColor = (
		document.getElementById("opponentColorSelect") as HTMLSelectElement
	).value;
...
function LoadFromStorage() {
	...
	(document.getElementById("playerColorSelect") as HTMLSelectElement).value =
		playerColor;

	(document.getElementById("opponentColorSelect") as HTMLSelectElement).value =
		opponentColor;

	const animationDuration = localStorage.getItem("animation-duration");

	if (animationDuration) {
		(document.getElementById("animationDuration") as HTMLInputElement).value =
			animationDuration;
	}
