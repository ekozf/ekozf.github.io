...
function CreateToastMsg(msg: string, isError: boolean = true) {
	if (isError) {
		console.error(msg);
	} else {
		console.log(msg);
	...
	const toastHeader = document.createElement("div") as HTMLDivElement;
	...
	const toastCloseButton = document.createElement(
		"button"
